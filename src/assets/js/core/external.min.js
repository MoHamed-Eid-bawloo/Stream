  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        return (
          i(c, t) || (a && i(u, t) ? (c[t] = u[t]) : (c[t] = p("Symbol." + t))),
          c[t]
        );
      };
    },
    ...
    function (t, e, n) {
      var r = n(16),
        ...
        d = function (t) {
          s(t, c, { value: { objectID: "O" + ++u, weakData: {} } });
        },
        h = (t.exports = {
          REQUIRED: !1,
          ...
          onFreeze: function (t) {
            return l && h.REQUIRED && p(t) && !i(t, c) && d(t), t;
          },
        });
      r[c] = !0;
    },
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        if (
          ...
          (_ = n.getConstructor(e, t, g, v)), (a.REQUIRED = !0);
        else if (i(t, !0)) {
          var A = new _(),
            S = A[v](m ? {} : -0, 1) != A,
            $ = p(function () {
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, u, p) {
        ...
        if (p) d = t;
          ...
          if (o(h)) {
            for (f = 0, g = i(t.length); g > f; f++)
              if (
                (m = u ? b(r((y = t[f]))[0], y[1]) : b(t[f])) &&
                m instanceof c
              )
                return m;
            return new c(!1);
    ...
    function (t, e, n) {
      var r,
        ...
        h = function () {
          ...
          for (var t = s.length; t--; ) delete h.prototype[s[t]];
          return h();
        };
      (a[u] = !0),
        (t.exports =
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, u, h, y, b) {
        ...
        var _,
          ...
          $ = !1,
          O = t.prototype,
          E = O[m] || O["@@iterator"] || (h && O[h]),
          T = (!g && E) || A(h),
          D = ("Array" == e && O.entries) || E;
        if (
          (D &&
            ((_ = i(D.call(new t()))),
            f !== Object.prototype &&
              ...
              (p ||
                i(_) === f ||
                (s ? s(_, f) : "function" != typeof _[m] && l(_, m, v)),
              a(_, S, !0, !0),
              p && (d[S] = v))),
          "values" == h &&
            E &&
          ...
          if (
            ...
            for (x in w) (!g && !$ && x in O) || c(O, x, w[x]);
          else r({ target: e, proto: !0, forced: g || $ }, w);
        return w;
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      if (p && d) {
        (r = l.getConstructor(f, "WeakMap", !0)), (s.REQUIRED = !0);
        var m = g.prototype,
          v = m.delete,
          y = m.has,
          b = m.get,
          ...
          getConstructor: function (t, e, n, c) {
            var p = t(function (t, r) {
              ...
              g = function (t, e, n) {
                var r = f(t),
                  s = o(i(e), !0);
                return !0 === s ? v(r).set(e, n) : (s[r.id] = n), t;
              };
            return (
              r(p.prototype, {
                delete: function (t) {
          ...
          return function (h, f, g, m) {
            for (
              var v,
                ...
                A = 0,
                S = m || a,
                $ = e ? S(h, x) : n ? S(h, 0) : void 0;
              x > A;
              A++
            )
              if ((d || A in _) && ((y = w((v = _[A]), A, b)), t))
                if (e) $[A] = y;
                else if (y)
                  switch (t) {
                    case 3:
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (n = new g((e = a(f.length))); e > _; _++)
            (h = y ? v(f[_], _) : f[_]), l(n, _, h);
        else
          for (
            d = (p = b.call(f)).next, n = new g();
            !(u = d.call(p)).done;
            _++
          )
            (h = y ? i(p, v, [u.value, _], !0) : u.value), l(n, _, h);
        return (n.length = _), n;
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      t.exports =
        ...
        o(function () {
          ...
          ? function (t, e) {
              for (
                var n = l(t), o = arguments.length, u = 1, p = s.f, d = a.f;
                o > u;
                ...
                for (
                  var h,
                    f = c(arguments[u++]),
                    g = p ? i(f).concat(p(f)) : i(f),
                    m = g.length,
                    v = 0;
                  m > v;

                )
                  (h = g[v++]), (r && !d.call(f, h)) || (n[h] = f[h]);
              return n;
            }
          : u;
    },
...
***************************************************************************** */
      ...
      var $ = (function () {
        ...
        O = (function () {
          ...
          return (
            ...
            (t.prototype.update = function (t, e, n) {
              g(this.element, { display: n <= e ? "none" : "block" }),
      ...
      function I(t) {
        ...
        function m(t) {
          return d(t, [c.element, c.thumb.element])
            ? j.X
            : d(t, [h.element, h.thumb.element])
            ? j.Y
            : void 0;
        }
        s(a, "click", function (e) {
          if (!n && d(e.target, [c.element, h.element])) {
            ...
            o === j.Y &&
              ((a = s.y - i.top - h.thumb.displaySize / 2),
          ...
          s(a, "mousedown", function (n) {
            if (d(n.target, [c.thumb.element, h.thumb.element])) {
              ...
              (o = m(s)),
                (r = { x: l.x - u.left, y: l.y - u.top }),
                (i = a.getBoundingClientRect()),
                g(t.containerEl, { "-user-select": "none" });
            }
          }),
          s(window, "mousemove", function (s) {
            if (e) {
              ...
              o === j.Y && ((l = a.y - r.y - i.top), t.setMomentum(0, f(o, l)));
            }
          }),
          s(window, "mouseup blur", function () {
            (e = n = !1), g(t.containerEl, { "-user-select": "" });
          });
      }
      function z(t) {
      ...
      function R(t) {
        ...
        n(window, "mousemove", function (n) {
          ...
          n(o, "contextmenu", function () {
            (s = !0), cancelAnimationFrame(e), (i = !1);
          }),
          n(o, "mousedown", function () {
            s = !1;
          }),
          n(o, "selectstart", function () {
            s || (cancelAnimationFrame(e), (i = !0));
          }),
          n(window, "mouseup blur", function () {
            cancelAnimationFrame(e), (i = !1), (s = !1);
          }),
          ...
          o(n, "touchmove", function (e) {
            if (!P || P === t) {
              ...
              t.addTransformableMomentum(o, i, e, function (n) {
                n && e.cancelable && (e.preventDefault(), (P = t));
              });
            }
          }),
        ...
        W = (function () {
          function t(t, e) {
            ...
            (this.options = new S(e)),
              ...
              g(t, { overflow: "hidden", outline: "none" }),
              ...
              (this._plugins = (function (t, e) {
                return Array.from(k.order)
                  .filter(function (t) {
                    return !1 !== e[t];
                  })
                  .map(function (n) {
                    var r = new (0, k.constructors[n])(t, e[n]);
                ...
                (function (t, e, n, r, o) {
                  ...
                  cancelAnimationFrame(T.get(t)),
                    (function e() {
                      ...
                      if ((t.setPosition(d + f * o, h + g * o), n >= r))
      ...
      var K = (function (t) {
        ...
        return (
          ...
          (e.init = function (t, e) {
            ...
            return V(), F.has(t) ? F.get(t) : new W(t, e);
          }),
          ...
          (e.use = function () {
            ...
            return function () {
              ...
              t.forEach(function (t) {
                ...
                k.order.add(e), (k.constructors[e] = t);
              });
            }.apply(void 0, t);
          }),
  ...
  (function (t, e) {
    ...
    return (() => {
      ...
      var t = {
        ...
        e = {};
      t.r(e), t.d(e, { default: () => n, divideNumbers: () => o });
      const n = (t, e = {}) => {
          const { action: n = "start", duration: i = 1e3, delay: s = 16 } = e;
          if ("stop" === n) return void r(t);
          if ((r(t), !/[0-9]/.test(t.innerHTML))) return;
        ...
        o = (t, e = {}) => {
          ...
          for (let t = 0; t < i.length; t++)
            if (/([0-9.][,.0-9]*[0-9]*)/.test(i[t]) && !/<[^>]+>/.test(i[t])) {
              let e = i[t];
              const n = [...e.matchAll(/[.,]/g)]
                .map((t) => ({ char: t[0], i: e.length - t.index - 1 }))
                .sort((t, e) => t.i - e.i);
              e = e.replace(/[.,]/g, "");
              let r = s.length - 1;
              for (let t = o; t >= 1; t--) {
            ...
            } else for (let e = 0; e < o; e++) s[e] += i[t];
          return (s[s.length] = t.toString()), s;
        };
      return e;
    })();
  }),
  (function (t) {
      ...
      g =
        (((x =
          ...
          (o = function (t, e, n, o) {
            ...
            if ("undefined" == v || "function" == v) {
              for (
                e =
                  !e.length && n.length ? ["require", "exports", "module"] : e,
                  h = 0;
                h < e.length;
                h += 1
              )
                if ("require" === (u = (d = s(e[h], _)).f)) g[h] = a.require(t);
                else if ("exports" === u) (g[h] = a.exports(t)), (f = !0);
                else if ("module" === u) i = g[h] = a.module(t);
                else if (m(l, u) || m(c, u) || m(p, u)) g[h] = b(u);
                else {
          ...
          (e =
            ...
            i =
              function (t, e, n, l, c) {
                ...
                if (!t.splice) {
                  if (((u = t).deps && i(u.deps, u.callback), !e)) return;
        ...
        x.define("select2/utils", ["jquery"], function (t) {
              ...
              for (var e in t) {
                ...
                if (1 !== n.length) {
                  for (var o = 0; o < n.length; o++) {
                    var i = n[o];
                    (i = i.substring(0, 1).toLowerCase() + i.substring(1)) in
                      r || (r[i] = {}),
          ...
          return (
            ...
            (e.GetData = function (n, r) {
              ...
              return r
                ? e.__cache[o] && null != e.__cache[o][r]
                  ? e.__cache[o][r]
                  : t(n).data(r)
                : e.__cache[o];
            }),
            ...
            (e.copyNonInternalCssClasses = function (t, e) {
              var n = (n = t.getAttribute("class").trim().split(/\s+/)).filter(
                function (t) {
                  ...
                  function (n) {
                    ...
                    r.hasClass("select2-results__option--selected")
                      ? o.options.get("multiple")
                        ? o.trigger("unselect", { originalEvent: n, data: i })
                        : o.trigger("close", {})
                      : o.trigger("select", { originalEvent: n, data: i });
                  }
                ),
                this.$results.on(
                  "mouseenter",
                  ...
                  function (n) {
                    ...
                    o
                      ...
                      o.trigger("results:focus", { data: r, element: t(this) });
                  }
                );
            }),
                ...
                if ((this.clear(), 0 !== t.length)) {
                  for (
                    ...
                    c && s.attr("title", c),
                      ...
                      (c = s.find(".select2-selection__choice__remove")).attr(
                        "title",
                        a()
                      ),
                      c.attr("aria-label", a()),
        ...
        x.define("select2/translation", ["jquery", "require"], function (t, e) {
          ...
          return (
            ...
            (n.loadPath = function (t) {
              var r;
              return (
                t in n._cache || ((r = e(t)), (n._cache[t] = r)),
                new n(n._cache[t])
              );
            }),
            n
            ...
            return (
              ...
              (r.prototype.select = function (t) {
                ...
                if (
                  ((t.selected = !0),
                  null != t.element &&
                    "option" === t.element.tagName.toLowerCase())
                )
                  return (
              ...
              (r.prototype.option = function (t) {
                ...
                return (
                  t.children
                    ? ((r = document.createElement("optgroup")).label = t.text)
                    : void 0 !==
              ...
              (r.prototype.item = function (t) {
                ...
                return (
                  ((r = this._normalizeItem(r)).element = t[0]),
              ...
              (r.prototype._applyDefaults = function (t) {
                var e = {
                  ...
                  transport: function (t, e, r) {
                    return (t = n.ajax(t)).then(e), t.fail(r), t;
                  },
                };
          ...
          function e(t, e, n) {
            ...
            if (
              ...
              for (var i = 0; i < r.length; i++) {
                var s = r[i];
                (s = this._normalizeItem(s)), (s = this.option(s));
                ...
                null != e.term && null == e.page
                  ? t.call(this, e, function t(o, i) {
                      ...
                      var u,
                        p = r.createTag(e);
                      null != p &&
                        ((u = r.option(p)).attr("data-select2-tag", "true"),
                        r.addOptions([u]),
                        r.insertTag(s, p)),
                        (o.results = s),
                        n(o);
          ...
          return (
            ...
            (e.prototype.tokenizer = function (e, n, r, o) {
              for (
                ...
                -1 !== i.indexOf(c)
                  ? ((c = s.substr(0, a)),
                    null != (c = l(t.extend({}, n, { term: c })))
                      ? (o(c), (s = s.substr(a + 1) || ""), (a = 0))
                      : a++)
                  : a++;
              }
              return { term: s };
          ...
          return (
            ...
            (t.prototype._checkIfMaximumSelected = function (t, e) {
              ...
              this.current(function (t) {
                (t = null != t ? t.length : 0),
                  0 < n.maximumSelectionLength && t >= n.maximumSelectionLength
          ...
          return (
            ...
            (e.prototype.bind = function (e, n, r) {
              ...
              e.call(this, n, r),
                ...
                n.on("results:focus", function (t) {
                  t.data._resultId
                    ? o.$search.attr("aria-activedescendant", t.data._resultId)
                    : o.$search.removeAttr("aria-activedescendant");
                });
            }),
          ...
          function (t, e) {
            ...
            return (
              ...
              (n.prototype.render = function (e) {
                var n = t("<span></span>");
                e = e.call(this);
                return n.append(e), (this.$dropdownContainer = n);
              }),
              ...
              (n.prototype._attachPositioningHandler = function (n, r) {
                ...
                (r = this.$container.parents().filter(e.hasScroll)).each(
                  function () {
              ...
              (n.prototype._positionDropdown = function () {
                ...
                var a = this.$dropdown.outerHeight(!1),
                  ...
                  u = l < i.top - a;
                (e = c > i.bottom + a), (l = { left: i.left, top: s.bottom });
                "static" === (c = this.$dropdownParent).css("position") &&
                  (c = c.offsetParent()),
                  (i = { top: 0, left: 0 }),
                  (t.contains(document.body, c[0]) || c[0].isConnected) &&
                    (i = c.offset()),
                  (l.top -= i.top),
                  (l.left -= i.left),
                  n || r || (o = "below"),
        ...
        x.define("select2/dropdown/selectOnClose", ["../utils"], function (t) {
          ...
          return (
            ...
            (e.prototype._handleSelectOnClose = function (e, n) {
              ...
              (r = this.getHighlightedResults()).length < 1 ||
                (null != (r = t.GetData(r[0], "data")).element &&
                  r.element.selected) ||
        ...
        x.define(
          ...
          function (
            ...
            return (
              (j.prototype.apply = function (u) {
                var p;
                null == (u = t.extend(!0, {}, this.defaults, u)).dataAdapter &&
                  (null != u.ajax
                    ? (u.dataAdapter = f)
                    : null != u.data
                    ? (u.dataAdapter = h)
                  ...
                  null == u.resultsAdapter &&
                    ((u.resultsAdapter = e),
                    null != u.ajax &&
                      (u.resultsAdapter = c.Decorate(u.resultsAdapter, A)),
                    null != u.placeholder &&
                      (u.resultsAdapter = c.Decorate(u.resultsAdapter, x)),
                    u.selectOnClose &&
                      (u.resultsAdapter = c.Decorate(u.resultsAdapter, O)),
                    u.tags &&
                      (u.resultsAdapter = c.Decorate(u.resultsAdapter, D))),
                  null == u.dropdownAdapter &&
                    (u.multiple
                      ? (u.dropdownAdapter = _)
                      : ((p = c.Decorate(_, w)), (u.dropdownAdapter = p)),
              ...
              (j.prototype.reset = function () {
                ...
                this.defaults = {
                  ...
                  matcher: function n(r, o) {
                    if (null == r.term || "" === r.term.trim()) return o;
                    if (o.children && 0 < o.children.length) {
                      for (
                        var i = t.extend(!0, {}, o), s = o.children.length - 1;
                        0 <= s;
                        s--
                      )
              ...
              (j.prototype._resolveLanguage = function (e) {
                ...
                for (
                  var n, r = Array.isArray(e) ? e : [e], o = [], i = 0;
                  i < r.length;
                  i++
                )
                  o.push(r[i]),
              ...
              (j.prototype._processTranslations = function (e, n) {
                for (var r = new u(), o = 0; o < e.length; o++) {
                  ...
                  else i = t.isPlainObject(s) ? new u(s) : s;
                  r.extend(i);
                }
                return r;
              }),
          ...
          function (t, e, n) {
            function r(t, n) {
              (this.options = t),
                ...
                null != n &&
                  (this.options = e.applyFromElement(this.options, n)),
            ...
            return (
              (r.prototype.fromElement = function (e) {
                ...
                var c,
                  u = t.extend(!0, {}, n.GetData(e[0]), o);
                for (c in (u = n._convertData(u)))
                  -1 < r.indexOf(c) ||
                    (t.isPlainObject(this.options[c])
                      ? t.extend(this.options[c], u[c])
                      : (this.options[c] = u[c]));
                return this;
              }),
            ...
            return (
              ...
              (o.prototype.trigger = function (t, e) {
                ...
                if (
                  ...
                  var r = i[t],
                    i = { prevented: !1, name: t, args: e };
                  if ((n.call(this, r, i), i.prevented))
    ...
    function b(t) {
      var e;
      if (
        (m(c, t) && ((e = c[t]), delete c[t], (p[t] = !0), o.apply(r, e)),
        !m(l, t) && !m(p, t))
      )
    ...
    function _(t) {
      var e,
        n = t ? t.indexOf("!") : -1;
      return (
        -1 < n && ((e = t.substring(0, n)), (t = t.substring(n + 1, t.length))),
        [e, t]
      );
    }
    function w(t) {
